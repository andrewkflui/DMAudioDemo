...
public class WaveHarmonicsGeneratorApplication extends javax.swing.JFrame {

    private SimpleClipPlayer simplePlayer;
    private TutorialFrame tutorialFrame;

    /** Creates new form WaveGeneratorApplication */
    public WaveHarmonicsGeneratorApplication() {
        initComponents();
        simplePlayer = streamPlayerPanel1.startSimplePlayer();
        WaveHarmonicsGenerator generator = waveHarmonicsGeneratorPanel1.getWaveHarmonicsGenerator();
        simplePlayer.load(generator.getAudioDataBuffer());
        simplePlayer.setLoop(-1);
        simplePlayer.play();
        waveVisualiserPanel1.setAudioData(generator.getAudioDataBuffer());
        waveVisualiserPanel1.setRepeatDraw(true);
        spectrumVisualiserPanel1.setAudioData(generator.getAudioDataBuffer());
        try {
            tutorialFrame = new TutorialFrame();
            tutorialFrame.loadText("/tutorial/WaveHarmonicsGenerator.htm");
    ...
    private void initComponents() {
        ...
        waveHarmonicsGeneratorPanel1 = new faifai.audio.WaveHarmonicsGeneratorPanel();
        spectrumVisualiserPanel1 = new faifai.audio.SpectrumVisualiserPanel();
        ...
        setTitle("Wave Harmonics Generator Demo");
        ...
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        getContentPane().add(waveHarmonicsGeneratorPanel1, gridBagConstraints);

        spectrumVisualiserPanel1.setPreferredSize(new java.awt.Dimension(320, 120));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        getContentPane().add(spectrumVisualiserPanel1, gridBagConstraints);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new WaveHarmonicsGeneratorApplication().setVisible(true);
            }
        });
    }
    ...
    private faifai.audio.SpectrumVisualiserPanel spectrumVisualiserPanel1;
    private faifai.audio.SimpleClipPlayerPanel streamPlayerPanel1;
    private faifai.audio.WaveHarmonicsGeneratorPanel waveHarmonicsGeneratorPanel1;
