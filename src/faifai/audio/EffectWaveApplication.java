...
public class EffectWaveApplication extends javax.swing.JFrame {

  private SimpleClipPlayer simplePlayer;

  /** Creates new form WaveGeneratorApplication */
  public EffectWaveApplication() {
    initComponents();
    try {
    ...
    WaveGenerator waveGenerator = waveGeneratorPanel1.getWaveGenerator();
    EffectProcess effectProcess = effectControlPanel1.startEffectProcess();
    AudioDataBuffer outputDataBuffer = effectProcess.connect(waveGenerator.getAudioDataBuffer());
  ...
  private void initComponents() {
    ...
    setTitle("Audio Effect Demo (Wave Generator)");
    ...
    jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Audio Playback Control", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 3, 11), new java.awt.Color(255, 255, 255))); // NOI18N
  ...
  public static void main(String args[]) {
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {
        new EffectWaveApplication().setVisible(true);
      }
    });
  }
